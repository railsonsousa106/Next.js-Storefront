...
export type ProductDetailsQuery = (
  ...
  & { product?: Maybe<(
    { __typename?: 'Product' }
    & Pick<Product, 'id' | 'slug' | 'name' | 'description'>
...
export const GetAllProductPathsDocument = gql`
...
/**
 * __useGetAllProductPathsQuery__
 *
 * To run a query within a React component, call `useGetAllProductPathsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllProductPathsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllProductPathsQuery({
 *   variables: {
 ...
 * });
 */
export function useGetAllProductPathsQuery(baseOptions?: Apollo.QueryHookOptions<GetAllProductPathsQuery, GetAllProductPathsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllProductPathsQuery, GetAllProductPathsQueryVariables>(GetAllProductPathsDocument, options);
      }
export function useGetAllProductPathsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllProductPathsQuery, GetAllProductPathsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllProductPathsQuery, GetAllProductPathsQueryVariables>(GetAllProductPathsDocument, options);
        }
export type GetAllProductPathsQueryHookResult = ReturnType<typeof useGetAllProductPathsQuery>;
export type GetAllProductPathsLazyQueryHookResult = ReturnType<typeof useGetAllProductPathsLazyQuery>;
export type GetAllProductPathsQueryResult = Apollo.QueryResult<GetAllProductPathsQuery, GetAllProductPathsQueryVariables>;